...
class ManageTestimonials extends React.Component {
  ...
  approveTestimonial = (testimonial) => {
    ...
    BasePath.put(`/webresources/ApproveTestimonial/${token}/${id}`).then(
      (result) => {
  ...
  deleteTest = () => {
    ...
    BasePath.put(`/webresources/DeleteTestimonial/${token}/${id}`).then(
      (result) => {
        console.log(result.data);
        this.updateTestimonials();
      }
        ...
        <div>
          ...
          {this.state.testimonialsList.map((testimonial) => (
            <Testimonial
              ...
              approveTestimonial={this.approveTestimonial.bind(
                this,
                testimonial
              )}
