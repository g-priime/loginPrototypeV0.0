            ...
            <div className="ui segment d-flex justify-content-around p-0 m-0 bg card-group">
                ...
                <Card className="cardbg">
                    ...
                    <CardBody>
                        ...
                        <CardText className="left">Most of the problems you’re having with your dog can be solved by understanding the underlying cause of the behaviour. That’s why our Private Training sessions are so valuable. You get one-on-one help to zero in on the issue, so you can solve it a lot faster.

<br></br><br></br>We start all of our Private Training options with an in person private consultation. That way we can meet you and your dog, and give you the opportunity to tell us exactly what’s been going on. Once we get all the information, we start the behaviour modifying protocol and develop a personalized training program to give you both the perfect solution.
                            
<br></br><br></br>After the private consultation, you can purchase the training bundle that’s right for you.</CardText><br></br>
                        <CardSubtitle><h4 style={{ color: "#715d5c" }}>$70/hour +5% GST</h4></CardSubtitle>
                        <CardText><small className="text-muted">Initial 90 min sessions are $130+5% GST</small></CardText><br></br>
                        <Button className="button">Book Now</Button>
                    </CardBody>
                </Card>
                <Card className="cardbg">
